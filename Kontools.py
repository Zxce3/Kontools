...
def menu():
    ...
    print(""" 
----
Script khusus untuk Termux
chat me :+6281315126056
telegram: t.me/Jking_666
DEEBWEB INTERNASIONAL COMUNITY
----
==========================================
00. Install Semua
...
while loop:
    ...
    if what == "00":
        print("================================")
        print("Lu yakin mau install: nmap, hydra, sqlmap, metasploit, ngrok, angryFuzzer, red_hawk, weeman, IPGeoLocation, cupp, instahack, TwitterSniper, Hash-Buster, D-TECT, routersploit and viSQL Cuma satu klik :D.")
        print("----------------")
        hm = input("[?] Yakin mau lanjut ?? (y/n): ")
        print("================================")
        if hm == "y":
            print("========================================================")
            print("[+] Mending lu buat kopi dulu cuk...")
            print("W jamin install nih bakalan lama cuk.")
            print("========================================================")
    ...
    if what == "1":
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] nmap berhasil di install cuk  :)")
        print("[+] Ketik 'nmap' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] hydra berhasil di install cuk  :)")
        print("[+] Ketik 'hydra' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] SQLMap berhasil di install cuk  :)")
        print("[+] Pergi ke sqlmap folder dan ketik 'python2 sqlmap.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] Metasploit berhasil di install cuk  :)")
        print("[+] Ketik 'msfconsole' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] ngrok berhasil di install cuk  :)")
        print("[+] Pergi ke ngrok folder dan ketik './ngrok http 80' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] Nethunter berhasil di install cuk  :)")
        print("[+] Pergi ke Nethunter-In-Termux folder dan ketik './kalinethunter' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] angryFuzzer berhasil di install cuk  :)")
        print("[+] Pergi ke angryFuzzer folder dan ketik 'python2 angryFuzzer.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] RED_HAWK berhasil di install cuk  :)")
        print("[+] Pergi ke RED_HAWK folder dan ketik 'php rhawk.php' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] weeman berhasil di install cuk  :)")
        print("[+] Pergi ke weeman folder dan ketik 'python2 weeman.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] IPGeoLocation berhasil di install cuk  :)")
        print("[+] Pergi ke IPGeoLocation folder dan ketik 'python ipgeolocation.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home && git clone https://github.com/Mebus/cupp.git")
        print("====================================")
        print("[+] Cupp berhasil di install cuk  :)")
        print("[+] Pergi ke cupp folder dan ketik 'python cupp3.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home && git clone https://github.com/avramit/instahack.git")
        print("====================================")
        print("[+] Instahack berhasil di install cuk  :)")
        print("[+] Pergi ke instahack folder dan ketik 'python hackinsta.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home && git clone https://github.com/abdallahelsokary/TwitterSniper.git")
        print("====================================")
        print("[+] TwitterSniper berhasil di install cuk  :)")
        print("[+] Pergi ke TwitterSniper folder dan ketik 'python TwitterSniper.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("====================================")
        print("[+] Ubuntu berhasil di install cuk  :)")
        print("[+] Pergi ke termux-ubuntu folder dan ketik './start.sh' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("====================================")
        print("[+] Fedora berhasil di install cuk  :)")
        print("[+] Ketik 'sh termux-fedora.sh f26_arm64' or 'sh termux-fedora.sh f26_arm' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home && git clone https://github.com/blackvkng/viSQL.git")
        print("====================================")
        print("[+] viSQL berhasil di install cuk  :)")
        print("[+] Pergi ke viSQL folder dan ketik 'python2 viSQL.py --help' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home && git clone https://github.com/UltimateHackers/Hash-Buster.git")
        print("====================================")
        print("[+] Hash-Buster berhasil di install cuk  :)")
        print("[+] Pergi ke Hash-Buster folder dan ketik 'python2 hash.py' untuk mulai :D")
        print("====================================")
        rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        if rmenu == "y":
            ...
            os.system("pip2 install -r requests")
            print("====================================")
            print("[+] routersploit berhasil di install cuk  :)")
            print("[+] Pergi ke routersploit folder dan ketik 'python2 rsf.py' untuk mulai :D")
            print("====================================")
            rmenu = input("[?] Mau ke menu lagi cuk?? (y/n): ")
            if rmenu == "y":
                menu()
